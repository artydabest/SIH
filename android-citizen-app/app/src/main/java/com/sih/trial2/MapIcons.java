 ...
 *   Safe Circle member safe   = green circle with a checkmark
 *   Safe Circle member unsafe = red circle with an exclamation
 *   Safe place                = green square with a cross (shelter sign)
 *   Volunteer                 = blue square with a phone dot
