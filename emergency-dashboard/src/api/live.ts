...
export type LiveEvent =
  ...
  | { type: "warning"; warning: SimWarning }
  | { type: "warning-update"; warning: SimWarning };
...
export function connectLive(
  ...
  socket.on("warning:new", (warning: SimWarning) => {
    onEvent({ type: "warning", warning });
  });

  socket.on("warning:update", (warning: SimWarning) => {
    onEvent({ type: "warning-update", warning });
  });
